...
var Post = function () {
  ...
  function Post(review, facebookPageUrl, modulePrefix) {
    ...
    var reviewUserPic = review.reviewer.imgUrl ? '../img/' + review.reviewer.imgUrl + '.jpg' : '//graph.facebook.com/v2.8/' + review.reviewer.id + '/picture';
