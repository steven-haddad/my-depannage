...
if (!class_exists('AnblogOwlCarousel')) {

    class AnblogOwlCarousel
    {
        const MODULE_NAME = 'antempcp';
        ...
        public function getOwlCarouselAdminFormOptions()
        {
            return array(
                ...
                array(
                    ...
                    'desc' => $this->l(
                        'This variable allows you to set the maximum amount of items
                ...
                /*
                  array(
                  'type' => 'select',
                  'label' => $this->l('Transition Style', array(), 'Modules.Anblog.Admin'),
                  'name' => 'owl_transitionStyle',
                  'default' => ANmanagewidgetsOwlCarousel::TRANSITIONSTYLE_FADE,
                  'form_group_class' => 'carousel_type_sub carousel_type-' . self::CAROUSEL_OWL,
                  'options' => array(
                  'query' => ANmanagewidgetsOwlCarousel::getTransitionStyleOptions(),
                  'id' => 'value',
                  'name' => 'name'
                  )
                  ),
                ...
                array(
                    'type' => 'html',
                    'name' => 'noname',
                    'html_content' => $this->l('Items for Screens'),
                    'default' => 'novalue',
                    'form_group_class' => 'carousel_type_sub carousel_type-'.self::CAROUSEL_OWL,
                ),
                array(
                    ...
                    'desc' => $this->l(
                        'This allows you to preset the number of slides visible with ItemsDeskto
                     (1199). Value 0 to disable. (Ex 4).'
                    ),
                    'default' => '0',
                ...
                array(
                    ...
                    'desc' => $this->l(
                        'This allows you to preset the number of slides visible with
                     itemsDesktopSmall (979px). Value 0 to disable. (Ex 3).'
                    ),
                    'default' => '0',
                    'form_group_class' => 'carousel_type_sub carousel_type-'.self::CAROUSEL_OWL,
                    'class' => 'digits',
                ...
                array(
                    ...
                    'desc' => $this->l(
                        'This allows you to preset the number of slides visible with
                     itemsTablet (768). Value 0 to disable. (Ex 2).'
                    ),
                    'default' => '0',
                    'form_group_class' => 'carousel_type_sub carousel_type-'.self::CAROUSEL_OWL,
                    'class' => 'digits',
                ...
                array(
                    ...
                    'desc' => $this->l(
                        'This allows you to preset the number of slides visible with
                     itemsTabletSmall (640). Value 0 to disable. (Ex 2).'
                    ),
                    'default' => '0',
                    'form_group_class' => 'carousel_type_sub carousel_type-'.self::CAROUSEL_OWL,
                    'class' => 'digits',
                ...
                array(
                    ...
                    'desc' => $this->l(
                        'This allows you to preset the number of slides visible with
                     itemsmobile (360). Value 0 to disable. (Ex 1).'
                    ),
                    'default' => '0',
                    'form_group_class' => 'carousel_type_sub carousel_type-'.self::CAROUSEL_OWL,
                    'class' => 'digits',
                ...
                array(
                    ...
                    'desc' => $this->l(
                        '(Advance User) Example: [[320, 1], [360, 1], [480, 2], [568, 2],
                     [600, 2], [640, 2], [768, 3], [900, 3], [960, 3], [1024, 4]]. The format is [x,y] whereby x=browser
                      width and y=number of slides displayed. Override all above Items. Value 0 to disable.'
                    ),
                    'default' => '0',
                    'form_group_class' => 'carousel_type_sub carousel_type-'.self::CAROUSEL_OWL,
                ...
                array(
                    ...
                    'is_bool' => true,
                    'desc' => $this->l(
                        'When pagination used, it skips loading the images from pages that got
                     skipped. It only loads the images that get displayed in viewport. If set to false, all images get
                      loaded when pagination used. It is a sub setting of the lazy load function.'
                    ),
                    'values' => self::getEnableOptions(),
                    'default' => self::ENABLE,
                    'form_group_class' => 'carousel_type_sub carousel_type-'.self::CAROUSEL_OWL,
                ...
                array(
                    'type' => 'html',
                    'name' => 'noname',
                    'html_content' => $this->l('Pagination'),
                    'default' => 'novalue',
                    'form_group_class' => 'carousel_type_sub carousel_type-'.self::CAROUSEL_OWL,
                ),
                array(
                ...
                array(
                    ...
                    'desc' => $this->l(
                        'Enter Time(miniseconds) to back first page. "Rewind Nav"
                     must be enable. Ex 1000'
                    ),
                    'default' => '1000',
                    'form_group_class' => 'carousel_type_sub carousel_type-'.self::CAROUSEL_OWL,
                    'class' => 'digits',
                ...
                array(
                    ...
                    'is_bool' => true,
                    'desc' => $this->l(
                        'Scroll per page not per item. This affect next/prev buttons and
                     mouse/touch dragging. Use "Slide Speed" to change animation speed.'
                    ),
                    'values' => self::getEnableOptions(),
                    'default' => self::DISABLE,
                    'form_group_class' => 'carousel_type_sub carousel_type-'.self::CAROUSEL_OWL,
