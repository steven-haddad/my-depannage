...
$res = (bool)Db::getInstance()->execute(
    'INSERT INTO `'._DB_PREFIX_."anblogcat`  (`id_anblogcat`, `image`, `id_parent`, `item`, `level_depth`, `active`, `position`, `submenu_content`, `privacy`, `position_type`, `menu_class`, `content`, `icon_class`, `level`, `left`, `right`, `date_add`, `date_upd`, `template`, `randkey`) VALUES
...
foreach ($langs as $l) {
    $sql = 'INSERT INTO `'._DB_PREFIX_."anblogcat_lang` (`id_anblogcat`, `id_lang`, `title`, `content_text`, `description`, `meta_keywords`, `meta_description`, `link_rewrite`) VALUES
		...
		(4, LANGUAGEID, 'Sub Category 1', '<p>Odio ut pretium ligula quam Vestibulum consequat convallis fringilla Vestibulum nulla. Accumsan morbi tristique auctor. At risus pretium urna tortor metus fringilla interdum mauris tempor congue</p>', '', 'joomla,prestashop,antheme,pavothemes', '', 'sub-category-1'),
...
$res = (bool)Db::getInstance()->execute(
    'INSERT INTO `'._DB_PREFIX_."anblog_blog` (`id_anblog_blog`, `id_anblogcat`, `position`, `date_add`, `active`, `user_id`, `hits`, `image`, `thumb`, `date_upd`, `video_code`, `params`, `featured`, `indexation`, `id_employee`, `product_ids`) VALUES
